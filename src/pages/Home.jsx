        ...
        <div className="py-32">
            <div className="flex justify-center items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-5">
                    {
                        data?.map((user, i) => (
                            <div key={user._id} className={`w-72 p-2 text-center bg-white rounded-lg border-[3px] border-[#c9c5c5]`}>
                                <div className={`px-12 py-6 text-center ${colors[i % colors.length]} rounded-lg lg:mt-0 xl:px-10`}>
